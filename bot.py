...
key = f"{deal.get('title', '')}{deal.get('price', 0)}"
...
# 🤖 AI / Smart Tech
("https://www.amazon.sa/s?k=ai+gadgets&rh=p_8%3A30-99", "🤖 AI Gadgets", False),
("https://www.amazon.sa/s?k=smart+devices&rh=p_8%3A30-99", "🏠 Smart Devices", False),
("https://www.amazon.sa/s?k=iot+devices&rh=p_8%3A30-99", "🌐 IoT Devices", False),
("https://www.amazon.sa/s?k=robot+vacuum&rh=p_8%3A30-99", "🤖 Robot Vacuum", False),
("https://www.amazon.sa/s?k=smart+watch+2025&rh=p_8%3A30-99", "⌚ Smart Watch 2025", False),

# 💸 Cheap / Budget Finds
("https://www.amazon.sa/s?k=under+50+sar", "💸 Under 50 SAR", False),
("https://www.amazon.sa/s?k=under+100+sar", "💸 Under 100 SAR", False),
("https://www.amazon.sa/s?k=cheap+electronics&rh=p_36%3A-10000", "💸 Cheap Electronics", False),
("https://www.amazon.sa/s?k=budget+gadgets", "💸 Budget Gadgets", False),
("https://www.amazon.sa/s?k=best+deals+today", "🔥 Best Deals Today", False),

# 🔥 Viral / Trending
("https://www.amazon.sa/s?k=tiktok+products", "🔥 TikTok Viral", False),
("https://www.amazon.sa/s?k=trending+products", "📈 Trending Products", False),
("https://www.amazon.sa/s?k=viral+gadgets", "🔥 Viral Gadgets", False),
("https://www.amazon.sa/s?k=amazon+finds", "🧲 Amazon Finds", False),

# ♻️ Renewed / Refurbished
("https://www.amazon.sa/s?k=renewed", "♻️ Renewed", False),
("https://www.amazon.sa/s?k=refurbished+laptop", "♻️ Refurb Laptop", False),
("https://www.amazon.sa/s?k=refurbished+iphone", "♻️ Refurb iPhone", False),
("https://www.amazon.sa/s?k=used+electronics", "♻️ Used Electronics", False),

# ⚡ High Discount Filters
("https://www.amazon.sa/s?k=discount+70%", "💥 70% OFF", False),
("https://www.amazon.sa/s?k=discount+80%", "💥 80% OFF", False),
("https://www.amazon.sa/s?k=hot+deals", "🔥 Hot Deals", False),
("https://www.amazon.sa/s?k=best+seller+discount", "🏆 Bestseller Deals", False),

# 🧳 Travel & Outdoor
("https://www.amazon.sa/s?k=camping+gear", "🏕️ Camping", False),
("https://www.amazon.sa/s?k=travel+accessories", "🧳 Travel Accessories", False),
("https://www.amazon.sa/s?k=suitcase", "🧳 Suitcase", False),
("https://www.amazon.sa/s?k=backpack", "🎒 Backpack", False),

# 🖥️ Work From Home
("https://www.amazon.sa/s?k=desk+setup", "🖥️ Desk Setup", False),
("https://www.amazon.sa/s?k=office+chair", "🪑 Office Chair", False),
("https://www.amazon.sa/s?k=mechanical+keyboard", "⌨️ Mechanical Keyboard", False),
("https://www.amazon.sa/s?k=monitor+arm", "🖥️ Monitor Arm", False),

# ================== 🔥 Dynamic Keywords ==================
keywords = ["discount", "offer", "deal", "cheap", "sale", "clearance", "limited"]

for kw in keywords:
    categories.append((
        f"https://www.amazon.sa/s?k={kw}&rh=p_8%3A30-99",
        f"🔥 {kw.title()} Deals",
        False
    ))
]  
